...
function App() {
	const movie = [
		...
		},
		{
			...
			category: ["fantastic", "detective", "horror"],
		...
		},
		{
			...
			category: ["fantastic", "comedy", "cartoon"],
			description:
		...
		},
		{
			...
			season: "1",
			img: "Mocn-Knight.png",
			category: ["fantastic", "action movie"],
